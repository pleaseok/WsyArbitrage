...
/**
 * @ClassName ApiSignature
 * @Description 签名认证 - 直接复制API文档
 * @Author Sean
 * @Date 2019/4/9 21:14
 **/
public class ApiSignature {
    ...
    /**
     * 创建一个有效的签名。该方法为客户端调用，
     * 将在传入的params中添加AccessKeyId、Timestamp、SignatureVersion、SignatureMethod、Signature参数。
    ...
    public void createSignature(String appKey, String appSecretKey, String method, String host,
        ...
        params.put("SignatureVersion", "2"); // 签名版本
